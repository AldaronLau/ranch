...
impl<const MIN: i32, const MAX: i32> RangedI32<MIN, MAX> {
    ...
    /// RangedI32::<1, 2>::new(1).unwrap();
    /// RangedI32::<1, 2>::new(2).unwrap();
    /// assert_eq!(RangedI32::<1, 2>::new(0).unwrap_err(), Error::NegOverflow);
    /// assert_eq!(RangedI32::<1, 2>::new(3).unwrap_err(), Error::PosOverflow);
    /// ```
    pub const fn new(value: impl AsRepr<i32>) -> Result<Self> {
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// RangedI32::<1, 3>::new_const::<1>();
    /// RangedI32::<1, 3>::new_const::<2>();
    /// RangedI32::<1, 3>::new_const::<3>();
    /// ```
    ///
    /// Does not compile:
    ///
    /// ```compile_fail
    /// RangedI32::<1, 3>::new_const::<0>();
    /// ```
    ///
    /// ```compile_fail
    /// RangedI32::<1, 3>::new_const::<4>();
    /// ```
    #[must_use]
    pub const fn new_const<const N: i32>() -> Self {
        const {
            if N < MIN || N > MAX {
                panic!("Out of bounds");
            }
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// assert_eq!(42, RangedI32::<1, 100>::new_const::<42>().get());
    /// ```
    #[must_use]
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// let n = RangedI32::<-128, 127>::new_const::<0b0101000>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// let a = RangedI32::<-128, 127>::new_const::<0b100_0000>();
    /// let b = RangedI32::<-128, 127>::new_const::<0b100_0011>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// let a = RangedI32::<1, 100>::new_const::<50>();
    /// let b = RangedI32::<1, 100>::new_const::<5>();
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// let a = RangedI32::<-100, 100>::new_const::<50>();
    /// let b = RangedI32::<-100, 100>::new_const::<5>();
    /// let c = a.saturating_add(b);
    /// let d = RangedI32::<-100, 100>::new_const::<-75>();
    ///
    ...
    /// let a = RangedI32::<-100, 100>::new_const::<50>();
    /// let b = RangedI32::<-100, 100>::new_const::<5>();
    /// let c = RangedI32::<-100, 100>::new_const::<-75>();
    ///
    ...
    /// let b = RangedI32::<-100, 100>::new_const::<5>();
    /// let c = RangedI32::<-100, 100>::new_const::<-75>();
    /// let d = RangedI32::<-100, 100>::new_const::<2>();
    ///
    ...
    /// let a = RangedI32::<-100, 10>::new_const::<-50>();
    /// let b = RangedI32::<-10, 100>::new_const::<50>();
    ///
    /// assert_eq!(
    ///     a.checked_div(2),
    ///     Ok(Quotient::Number(RangedI32::new_const::<-25>())),
    /// );
    ...
    /// assert_eq!(
    ///     a.saturating_div(2),
    ///     Quotient::Number(RangedI32::new_const::<-25>()),
    /// );
    /// assert_eq!(a.saturating_div(0), Quotient::Nan);
    /// assert_eq!(
    ///     a.saturating_div(-1),
    ///     Quotient::Number(RangedI32::new_const::<10>()),
    /// );
    /// assert_eq!(
    ///     b.saturating_div(-2),
    ///     Quotient::Number(RangedI32::new_const::<-10>()),
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// assert!(!RangedI32::<-100, 100>::new_const::<10>().is_negative());
    /// assert!(RangedI32::<-100, 100>::new_const::<-10>().is_negative());
    /// ```
    #[must_use]
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// assert!(RangedI32::<-100, 100>::new_const::<10>().is_positive());
    /// assert!(!RangedI32::<-100, 100>::new_const::<-10>().is_positive());
    /// ```
    #[must_use]
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// let a = RangedI32::<-8, 8>::new_const::<0>();
    /// let b = RangedI32::<-8, 8>::new_const::<2>();
    /// let c = RangedI32::<-8, 8>::new_const::<4>();
    /// let d = RangedI32::<-8, 8>::new_const::<-1>();
    /// let e = RangedI32::<-8, 8>::new_const::<-7>();
    /// let f = RangedI32::<-8, 8>::new_const::<-3>();
    /// let g = RangedI32::<-8, 8>::new_const::<3>();
    /// let h = RangedI32::<-8, 8>::new_const::<7>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// let a = RangedI32::<1, 3>::new_const::<1>();
    /// let b = RangedI32::<-1, 3>::new_const::<2>();
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// let a = RangedI32::<2, 5>::new_const::<3>();
    /// let b = RangedI32::<-1, 3>::new_const::<1>();
    ...
    /// ```rust
    /// # use ranch::RangedI32;
    /// let a = RangedI32::<-2, 3>::new_const::<1>();
    /// let b = RangedI32::<0, 3>::new_const::<2>();
    ...
    /// # use ranch::RangedI32;
    /// let a = RangedI32::<2, 5>::new_const::<3>();
    /// let b = RangedI32::<1, 2>::new_const::<2>();
    ...
    /// # use ranch::RangedI32;
    /// let a = RangedI32::<2, 5>::new_const::<3>();
    /// let b = RangedI32::<1, 2>::new_const::<1>();
    ...
    /// let a = RangedI32::<-1, 3>::new_const::<2>();
