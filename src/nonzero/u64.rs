...
#[repr(transparent)]
pub struct RangedNonZeroU64<const MIN: u64, const MAX: u64>(pub(crate) u64);
...
impl<const MIN: u64, const MAX: u64> RangedNonZeroU64<MIN, MAX> {
    ...
    /// RangedNonZeroU64::<1, 2>::with_u64(1).unwrap();
    /// RangedNonZeroU64::<1, 2>::with_u64(2).unwrap();
    /// assert_eq!(RangedNonZeroU64::<1, 2>::with_u64(0).unwrap_err(), Error::NegOverflow);
    /// assert_eq!(RangedNonZeroU64::<1, 2>::with_u64(3).unwrap_err(), Error::PosOverflow);
    /// ```
    pub const fn with_u64(value: impl AsRepr<u64>) -> Result<Self> {
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroU64;
    /// let n = RangedNonZeroU64::<{ u64::MIN }, { u64::MAX }>::MAX;
    ///
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroU64;
    /// let n = RangedNonZeroU64::<0, 255>::new::<0b0101000>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroU64;
    /// let a = RangedNonZeroU64::<0, 255>::new::<0b100_0000>();
    /// let b = RangedNonZeroU64::<0, 255>::new::<0b100_0011>();
    ///
    ...
    pub const fn saturating_add(self, other: impl AsRepr<u64>) -> Self {
        ...
        match Self::with_u64(self.get().saturating_add(other)) {
            Ok(value) => value,
            Err(_) => Self::MAX,
        }
    }
    ...
    /// let a = RangedNonZeroU64::<0, 100>::new::<50>();
    /// let b = RangedNonZeroU64::<0, 100>::new::<5>();
    /// let c = RangedNonZeroU64::<0, 100>::new::<75>();
    ///
    ...
    pub const fn saturating_mul(self, other: impl AsRepr<u64>) -> Self {
        ...
        match Self::with_u64(self.get().saturating_mul(other)) {
            Ok(value) => value,
            Err(_) => Self::MAX,
        }
    }
    ...
    /// let a = RangedNonZeroU64::<0, 100>::new::<50>();
    /// let b = RangedNonZeroU64::<0, 100>::new::<5>();
    /// let c = RangedNonZeroU64::<0, 100>::new::<2>();
    ///
    ...
    pub const fn saturating_pow(self, other: impl AsRepr<u32>) -> Self {
        ...
        match Self::with_u64(self.get().saturating_pow(other)) {
            Ok(value) => value,
            Err(_) => Self::MAX,
        }
    }
    ...
    /// assert_eq!(
    ///     a.saturating_div(2),
    ///     Quotient::Number(RangedNonZeroU64::new::<25>()),
    /// );
    /// assert_eq!(a.saturating_div(0), Quotient::Nan);
    /// assert_eq!(
    ///     b.saturating_div(2),
    ///     Quotient::Number(RangedNonZeroU64::new::<1>()),
    /// );
    /// ```
    #[must_use = "this returns the result of the operation, \
                  without modifying the original"]
    pub const fn saturating_div(self, rhs: impl AsRepr<u64>) -> Quotient<Self> {
        let rhs = as_repr::as_repr(rhs);
        ...
        Quotient::Number(match Self::with_u64(self.get().saturating_div(rhs)) {
            Ok(value) => value,
            Err(_) => Self::MIN,
        })
    }
    ...
    pub const fn saturating_sub(self, other: impl AsRepr<u64>) -> Self {
        ...
        match Self::with_u64(self.get().saturating_sub(other)) {
            Ok(value) => value,
            Err(_) => Self::MIN,
        }
    }
    ...
    /// ```rust
    /// # use ranch::{Error, RangedNonZeroU64};
    /// let a = RangedNonZeroU64::<0, 33>::new::<0>();
    /// let b = RangedNonZeroU64::<0, 33>::new::<9>();
    /// let c = RangedNonZeroU64::<0, 33>::new::<32>();
    /// let d = RangedNonZeroU64::<0, 33>::new::<33>();
    ///
    ...
    /// ```rust
    /// # use ranch::{Error, RangedNonZeroU64};
    /// let a = RangedNonZeroU64::<0, 32>::new::<0>();
    /// let b = RangedNonZeroU64::<0, 32>::new::<9>();
    /// let c = RangedNonZeroU64::<0, 32>::new::<32>();
    /// let d = RangedNonZeroU64::<0, 32>::new::<1>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroU64;
    /// let a = RangedNonZeroU64::<0, 8>::new::<0>();
    /// let b = RangedNonZeroU64::<0, 8>::new::<2>();
    /// let c = RangedNonZeroU64::<0, 8>::new::<4>();
    /// let d = RangedNonZeroU64::<0, 8>::new::<3>();
    /// let e = RangedNonZeroU64::<0, 8>::new::<7>();
    ///
    ...
    pub const fn midpoint(self, rhs: Self) -> Self {
        let Ok(value) = Self::with_u64(self.get().midpoint(rhs.get())) else {
    ...
    /// let output: RangedNonZeroU64::<2, 6> = a.ranged_add(b);
    ///
    ...
    /// let a = RangedNonZeroU64::<1, 3>::new::<1>();
    /// let b = RangedNonZeroU64::<1, 3>::new::<2>();
    /// let output: RangedNonZeroU64::<1, 6> = a.ranged_add(b);
    ///
    /// assert_eq!(output.get(), 3);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    >(
        ...
        RangedNonZeroU64(self.get() + rhs.get())
    }
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroU64;
    /// let a = RangedNonZeroU64::<2, 5>::new::<3>();
    /// let b = RangedNonZeroU64::<1, 2>::new::<1>();
    /// let output: RangedNonZeroU64::<0, 4> = a.ranged_sub(b);
    ///
    ...
    /// let a = RangedNonZeroU64::<2, 5>::new::<3>();
    /// let b = RangedNonZeroU64::<1, 2>::new::<1>();
    /// let output: RangedNonZeroU64::<0, 3> = a.ranged_sub(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedNonZeroU64::<2, 9> = a.ranged_mul(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    ///
    ...
    /// let a = RangedNonZeroU64::<1, 3>::new::<1>();
    /// let b = RangedNonZeroU64::<2, 3>::new::<2>();
    /// let output: RangedNonZeroU64::<1, 9> = a.ranged_mul(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// # use ranch::RangedNonZeroU64;
    /// let a = RangedNonZeroU64::<2, 5>::new::<3>();
    /// let b = RangedNonZeroU64::<1, 2>::new::<2>();
    /// let output: RangedNonZeroU64::<1, 2> = a.ranged_div(b);
    ///
    ...
    /// let a = RangedNonZeroU64::<2, 5>::new::<3>();
    /// let b = RangedNonZeroU64::<1, 2>::new::<1>();
    /// let output: RangedNonZeroU64::<0, 2> = a.ranged_div(b);
    ///
    /// assert_eq!(output.get(), 1);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    ///
    /// ```rust
    /// # use ranch::{RangedNonZeroU64, RangedNonZeroU32};
    /// let a = RangedNonZeroU64::<1, 3>::new::<2>();
    /// let b = RangedNonZeroU32::<2, 3>::new::<2>();
    /// let output: RangedNonZeroU64::<1, 27> = a.ranged_pow(b);
    ///
    ...
    /// let a = RangedNonZeroU64::<1, 3>::new::<2>();
    /// let b = RangedNonZeroU32::<2, 3>::new::<2>();
    /// let output: RangedNonZeroU64::<0, 27> = a.ranged_pow(b);
    ///
    /// assert_eq!(output.get(), 4);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    >(
        ...
        RangedNonZeroU64(self.get().pow(rhs.get()))
    }
}
    ...
    for RangedNonZeroU64<MIN, MAX>
{
    ...
    fn from_str(src: &str) -> ParsingResult<Self> {
        ...
        Self::with_u64(parsed).map_err(From::from)
    }
}
