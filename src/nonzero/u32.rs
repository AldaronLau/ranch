...
#[repr(transparent)]
pub struct RangedNonZeroU32<const MIN: u32, const MAX: u32>(
...
impl<const MIN: u32, const MAX: u32> RangedNonZeroU32<MIN, MAX> {
    ...
    /// RangedNonZeroU32::<2, 3>::with_u32(2).unwrap().unwrap();
    /// RangedNonZeroU32::<2, 3>::with_u32(3).unwrap().unwrap();
    /// assert_eq!(RangedNonZeroU32::<2, 3>::with_u32(0), Ok(None));
    /// assert_eq!(RangedNonZeroU32::<2, 3>::with_u32(1).unwrap_err(), Error::NegOverflow);
    /// assert_eq!(RangedNonZeroU32::<2, 3>::with_u32(4).unwrap_err(), Error::PosOverflow);
    /// ```
    pub const fn with_u32(value: impl AsRepr<u32>) -> Result<Option<Self>> {
    ...
    /// # use ranch::RangedNonZeroU32;
    /// assert_eq!(
    ///     RangedNonZeroU32::<1, 100>::with_nonzero(NonZero::new(42).unwrap()).unwrap(),
    ///     RangedNonZeroU32::<1, 100>::new::<42>(),
    /// );
    /// ```
    pub const fn with_nonzero(
        nonzero: impl AsRepr<NonZero<u32>>,
    ) -> Result<Self> {
    ...
    ///     RangedNonZeroU32::<1, 100>::new::<42>().to_nonzero(),
    /// );
    /// ```
    #[must_use]
    pub const fn to_nonzero(self) -> NonZero<u32> {
        self.0
    }
    ...
    /// # use ranch::{RangedNonZeroU32, RangedU32};
    /// assert_eq!(
    ///     RangedU32::<1, 100>::new::<42>(),
    ///     RangedNonZeroU32::<1, 100>::new::<42>().to_ranged(),
    /// );
    /// ```
    #[must_use]
    pub const fn to_ranged(self) -> RangedU32<MIN, MAX> {
        RangedU32(self.get())
    }
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroU32;
    /// let n = RangedNonZeroU32::<1, { u32::MAX }>::MAX;
    ///
    /// assert_eq!(n.leading_zeros().get(), 0);
    /// ```
    #[must_use]
    pub const fn leading_zeros(self) -> RangedU32<0, { u32::BITS }> {
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroU32;
    /// let n = RangedNonZeroU32::<1, 255>::new::<0b0101000>();
    ///
    /// assert_eq!(n.trailing_zeros().get(), 3);
    /// ```
    #[must_use]
    pub const fn trailing_zeros(self) -> RangedU32<0, { u32::BITS }> {
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroU32;
    /// let a = RangedNonZeroU32::<1, 255>::new::<0b100_0000>();
    /// let b = RangedNonZeroU32::<1, 255>::new::<0b100_0011>();
    ///
    /// assert_eq!(a.count_ones().get(), 1);
    /// assert_eq!(b.count_ones().get(), 3);
    /// ```
    #[must_use]
    pub const fn count_ones(self) -> RangedU32<0, { u32::BITS }> {
    ...
    /// let a = RangedNonZeroU32::<1, 100>::new::<50>();
    /// let b = RangedNonZeroU32::<1, 100>::new::<5>();
    /// let c = RangedNonZeroU32::<1, 100>::new::<75>();
    ///
    ...
    /// let a = RangedNonZeroU32::<1, 100>::new::<50>();
    /// let b = RangedNonZeroU32::<1, 100>::new::<5>();
    /// let c = RangedNonZeroU32::<1, 100>::new::<2>();
    ///
    ...
    /// ```rust
    /// # use ranch::{Error, RangedNonZeroU32};
    /// let a = RangedNonZeroU32::<1, 32>::new::<3>();
    /// let b = RangedNonZeroU32::<1, 32>::new::<9>();
    /// let c = RangedNonZeroU32::<1, 32>::new::<32>();
    /// let d = RangedNonZeroU32::<1, 32>::new::<1>();
    ///
    ...
    >(
        ...
        RangedNonZeroU32::with_ranged(self.to_ranged().ranged_pow(rhs)).unwrap()
    }
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroU32;
    /// let a = RangedNonZeroU32::<1, 8>::new::<1>();
    /// let b = RangedNonZeroU32::<1, 8>::new::<3>();
    /// let c = RangedNonZeroU32::<1, 8>::new::<5>();
    /// let d = RangedNonZeroU32::<1, 8>::new::<4>();
    /// let e = RangedNonZeroU32::<1, 8>::new::<8>();
    ///
    ...
    pub const fn midpoint(self, rhs: Self) -> Self {
        let Ok(Some(value)) = Self::with_u32(self.get().midpoint(rhs.get()))
        else {
