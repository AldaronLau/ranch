...
#[repr(transparent)]
pub struct RangedNonZeroI32<const MIN: i32, const MAX: i32>(pub(crate) i32);
...
impl<const MIN: i32, const MAX: i32> RangedNonZeroI32<MIN, MAX> {
    ...
    /// RangedNonZeroI32::<1, 2>::with_i32(1).unwrap();
    /// RangedNonZeroI32::<1, 2>::with_i32(2).unwrap();
    /// assert_eq!(RangedNonZeroI32::<1, 2>::with_i32(0).unwrap_err(), Error::NegOverflow);
    /// assert_eq!(RangedNonZeroI32::<1, 2>::with_i32(3).unwrap_err(), Error::PosOverflow);
    /// ```
    ...
    /// let d = RangedNonZeroI32::<-100, 100>::new::<-75>();
    ///
    ...
    /// assert_eq!(
    ///     a.checked_div(2),
    ///     Ok(Quotient::Number(RangedNonZeroI32::new::<-25>())),
    /// );
    ...
    /// assert_eq!(
    ///     a.saturating_div(2),
    ///     Quotient::Number(RangedNonZeroI32::new::<-25>()),
    /// );
    /// assert_eq!(a.saturating_div(0), Quotient::Nan);
    /// assert_eq!(
    ///     a.saturating_div(-1),
    ///     Quotient::Number(RangedNonZeroI32::new::<10>()),
    /// );
    /// assert_eq!(
    ///     b.saturating_div(-2),
    ///     Quotient::Number(RangedNonZeroI32::new::<-10>()),
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroI32;
    /// let a = RangedNonZeroI32::<-8, 8>::new::<0>();
    /// let b = RangedNonZeroI32::<-8, 8>::new::<2>();
    /// let c = RangedNonZeroI32::<-8, 8>::new::<4>();
    /// let d = RangedNonZeroI32::<-8, 8>::new::<-1>();
    /// let e = RangedNonZeroI32::<-8, 8>::new::<-7>();
    /// let f = RangedNonZeroI32::<-8, 8>::new::<-3>();
    /// let g = RangedNonZeroI32::<-8, 8>::new::<3>();
    /// let h = RangedNonZeroI32::<-8, 8>::new::<7>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroI32;
    /// let a = RangedNonZeroI32::<1, 3>::new::<1>();
    /// let b = RangedNonZeroI32::<-1, 3>::new::<2>();
    /// let output: RangedNonZeroI32::<0, 6> = a.ranged_add(b);
    ///
    ...
    /// let a = RangedNonZeroI32::<1, 3>::new::<1>();
    /// let b = RangedNonZeroI32::<-1, 3>::new::<2>();
    /// let output: RangedNonZeroI32::<1, 6> = a.ranged_add(b);
    ///
    /// assert_eq!(output.get(), 3);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    >(
        ...
        RangedNonZeroI32(self.get() + rhs.get())
    }
    ...
    /// ```rust
    /// # use ranch::RangedNonZeroI32;
    /// let a = RangedNonZeroI32::<2, 5>::new::<3>();
    /// let b = RangedNonZeroI32::<-1, 3>::new::<1>();
    /// let output: RangedNonZeroI32::<-1, 6> = a.ranged_sub(b);
    ///
    ...
    /// let a = RangedNonZeroI32::<2, 5>::new::<3>();
    /// let b = RangedNonZeroI32::<-1, 3>::new::<1>();
    /// let output: RangedNonZeroI32::<0, 6> = a.ranged_sub(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let b = RangedNonZeroI32::<0, 3>::new::<2>();
    /// let output: RangedNonZeroI32::<-6, 9> = a.ranged_mul(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    ///
    ...
    /// let a = RangedNonZeroI32::<-2, 3>::new::<1>();
    /// let b = RangedNonZeroI32::<0, 3>::new::<2>();
    /// let output: RangedNonZeroI32::<0, 9> = a.ranged_mul(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// # use ranch::RangedNonZeroI32;
    /// let a = RangedNonZeroI32::<2, 5>::new::<3>();
    /// let b = RangedNonZeroI32::<1, 2>::new::<2>();
    /// let output: RangedNonZeroI32::<1, 2> = a.ranged_div(b);
    ///
    ...
    /// # use ranch::RangedNonZeroI32;
    /// let a = RangedNonZeroI32::<2, 5>::new::<3>();
    /// let b = RangedNonZeroI32::<1, 2>::new::<1>();
    /// let output: RangedNonZeroI32::<0, 2> = a.ranged_div(b);
    ///
    /// assert_eq!(output.get(), 1);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    ///
    /// ```rust
    /// # use ranch::{RangedNonZeroI32, RangedNonZeroU32};
    /// let a = RangedNonZeroI32::<-1, 3>::new::<2>();
    /// let b = RangedNonZeroU32::<2, 3>::new::<2>();
    /// let output: RangedNonZeroI32::<-1, 27> = a.ranged_pow(b);
    ///
    ...
    /// let a = RangedNonZeroI32::<1, 3>::new::<2>();
    /// let b = RangedNonZeroU32::<2, 3>::new::<2>();
    /// let output: RangedNonZeroI32::<0, 27> = a.ranged_pow(b);
    ///
    /// assert_eq!(output.get(), 4);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    >(
        ...
        RangedNonZeroI32(self.get().pow(rhs.get()))
    }
}
