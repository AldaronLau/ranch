...
impl<const MIN: u8, const MAX: u8> RangedU8<MIN, MAX> {
    ...
    /// ```rust
    /// # use ranch::RangedU8;
    /// assert_eq!(42, RangedU8::<1, 100>::new::<42>().get());
    /// ```
    #[must_use]
    ...
    /// ```rust
    /// # use ranch::RangedU8;
    /// let n = RangedU8::<0, 255>::new::<0b0101000>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU8;
    /// let a = RangedU8::<0, 255>::new::<0b100_0000>();
    /// let b = RangedU8::<0, 255>::new::<0b100_0011>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU8;
    /// let a = RangedU8::<1, 100>::new::<50>();
    /// let b = RangedU8::<1, 100>::new::<5>();
    ...
    /// let a = RangedU8::<0, 100>::new::<50>();
    /// let b = RangedU8::<0, 100>::new::<5>();
    /// let c = RangedU8::<0, 100>::new::<75>();
    ///
    ...
    /// let a = RangedU8::<1, 50>::new::<50>();
    /// let b = RangedU8::<1, 50>::new::<1>();
    ///
    /// assert_eq!(
    ///     a.checked_div(2),
    ///     Some(Quotient::Number(RangedU8::new::<25>())),
    /// );
    ...
    /// assert_eq!(
    ///     a.saturating_div(2),
    ///     Quotient::Number(RangedU8::new::<25>()),
    /// );
    /// assert_eq!(a.saturating_div(0), Quotient::Nan);
    /// assert_eq!(
    ///     b.saturating_div(2),
    ///     Quotient::Number(RangedU8::new::<1>()),
    /// );
    /// ```
    #[must_use = "this returns the result of the operation, \
                  without modifying the original"]
    ...
    /// ```rust
    /// # use ranch::{Error, RangedU8};
    /// let a = RangedU8::<0, 32>::new::<0>();
    /// let b = RangedU8::<0, 32>::new::<9>();
    /// let c = RangedU8::<0, 32>::new::<32>();
    /// let d = RangedU8::<0, 32>::new::<1>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU8;
    /// let a = RangedU8::<0, 8>::new::<0>();
    /// let b = RangedU8::<0, 8>::new::<2>();
    /// let c = RangedU8::<0, 8>::new::<4>();
    /// let d = RangedU8::<0, 8>::new::<3>();
    /// let e = RangedU8::<0, 8>::new::<7>();
    ///
    ...
    /// let output: RangedU8::<2, 6> = a.add_ranged(b);
    ///
    ...
    /// let a = RangedU8::<1, 3>::new::<1>();
    /// let b = RangedU8::<1, 3>::new::<2>();
    /// let output: RangedU8::<1, 6> = a.add_ranged(b);
    ///
    /// assert_eq!(output.get(), 3);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU8::<0, 4> = a.sub_ranged(b);
    ///
    ...
    /// let a = RangedU8::<2, 5>::new::<3>();
    /// let b = RangedU8::<1, 2>::new::<1>();
    /// let output: RangedU8::<0, 3> = a.sub_ranged(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU8::<2, 9> = a.mul_ranged(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    ///
    ...
    /// let a = RangedU8::<1, 3>::new::<1>();
    /// let b = RangedU8::<2, 3>::new::<2>();
    /// let output: RangedU8::<1, 9> = a.mul_ranged(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU8::<1, 2> = a.div_ranged(b);
    ///
    ...
    /// let a = RangedU8::<2, 5>::new::<3>();
    /// let b = RangedU8::<1, 2>::new::<1>();
    /// let output: RangedU8::<0, 2> = a.div_ranged(b);
    ///
    /// assert_eq!(output.get(), 1);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU8::<1, 27> = a.pow_ranged(b);
    ///
    ...
    /// let a = RangedU8::<1, 3>::new::<2>();
    /// let b = RangedU32::<2, 3>::new::<2>();
    /// let output: RangedU8::<0, 27> = a.pow_ranged(b);
    ///
    /// assert_eq!(output.get(), 4);
    /// ```
    #[must_use = "this returns the result of the operation, \
...
impl<const MIN: u8, const MAX: u8> crate::error::Clamp for RangedU8<MIN, MAX> {
