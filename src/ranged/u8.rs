...
impl<const MIN: u8, const MAX: u8> RangedU8<MIN, MAX> {
    ...
    /// let output: RangedU8::<2, 6> = a.ranged_add(b);
    ///
    ...
    /// let a = RangedU8::<1, 3>::new::<1>();
    /// let b = RangedU8::<1, 3>::new::<2>();
    /// let output: RangedU8::<1, 6> = a.ranged_add(b);
    ///
    /// assert_eq!(output.get(), 3);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU8::<0, 4> = a.ranged_sub(b);
    ///
    ...
    /// let a = RangedU8::<2, 5>::new::<3>();
    /// let b = RangedU8::<1, 2>::new::<1>();
    /// let output: RangedU8::<0, 3> = a.ranged_sub(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU8::<2, 9> = a.ranged_mul(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    ///
    ...
    /// let a = RangedU8::<1, 3>::new::<1>();
    /// let b = RangedU8::<2, 3>::new::<2>();
    /// let output: RangedU8::<1, 9> = a.ranged_mul(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU8::<1, 2> = a.ranged_div(b);
    ///
    ...
    /// let a = RangedU8::<2, 5>::new::<3>();
    /// let b = RangedU8::<1, 2>::new::<1>();
    /// let output: RangedU8::<0, 2> = a.ranged_div(b);
    ///
    /// assert_eq!(output.get(), 1);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU8::<1, 27> = a.ranged_pow(b);
    ///
    ...
    /// let a = RangedU8::<1, 3>::new::<2>();
    /// let b = RangedU32::<2, 3>::new::<2>();
    /// let output: RangedU8::<0, 27> = a.ranged_pow(b);
    ///
    /// assert_eq!(output.get(), 4);
    /// ```
    #[must_use = "this returns the result of the operation, \
