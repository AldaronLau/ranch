...
impl<const MIN: i32, const MAX: i32> RangedI32<MIN, MAX> {
    ...
    /// let output: RangedI32::<0, 6> = a.add_ranged(b);
    ///
    ...
    /// let a = RangedI32::<1, 3>::new::<1>();
    /// let b = RangedI32::<-1, 3>::new::<2>();
    /// let output: RangedI32::<1, 6> = a.add_ranged(b);
    ///
    /// assert_eq!(output.get(), 3);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    >(
        ...
        RangedI32::from_unchecked(self.get() + rhs.get())
    }
    ...
    /// let output: RangedI32::<-1, 6> = a.sub_ranged(b);
    ///
    ...
    /// let a = RangedI32::<2, 5>::new::<3>();
    /// let b = RangedI32::<-1, 3>::new::<1>();
    /// let output: RangedI32::<0, 6> = a.sub_ranged(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedI32::<-6, 9> = a.mul_ranged(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    ///
    ...
    /// let a = RangedI32::<-2, 3>::new::<1>();
    /// let b = RangedI32::<0, 3>::new::<2>();
    /// let output: RangedI32::<0, 9> = a.mul_ranged(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedI32::<1, 2> = a.div_ranged(b).number().unwrap();
    ///
    ...
    /// let output: RangedI32::<0, 2> = a.div_ranged(b).number().unwrap();
    ///
    /// assert_eq!(output.get(), 1);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    >(
        self,
        rhs: RangedI32<RHS_MIN, RHS_MAX>,
    ) -> Quotient<RangedI32<OUTPUT_MIN, OUTPUT_MAX>> {
        const {
            let (min_min, min_max) = (MIN / RHS_MIN, MIN / RHS_MAX);
            let (max_min, max_max) = (MAX / RHS_MIN, MAX / RHS_MAX);
            let min = if min_min < min_max { min_min } else { min_max };
        ...
        if rhs.get() == 0 {
            ...
            Quotient::Number(RangedI32::from_unchecked(self.get() / rhs.get()))
        }
    }
    ...
    /// let output: RangedI32::<-1, 27> = a.pow_ranged(b);
    ///
    ...
    /// let a = RangedI32::<1, 3>::new::<2>();
    /// let b = RangedU32::<2, 3>::new::<2>();
    /// let output: RangedI32::<0, 27> = a.pow_ranged(b);
    ///
    /// assert_eq!(output.get(), 4);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    >(
        ...
        RangedI32::from_unchecked(self.get().pow(rhs.get()))
    }
}
...
impl<const MIN: i32, const MAX: i32> error::Clamp for RangedI32<MIN, MAX> {
