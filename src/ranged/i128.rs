...
impl<const MIN: i128, const MAX: i128> RangedI128<MIN, MAX> {
    ...
    /// RangedI128::<1, 3>::new::<1>();
    /// RangedI128::<1, 3>::new::<2>();
    /// RangedI128::<1, 3>::new::<3>();
    /// ```
    ///
    /// Does not compile:
    ///
    ...
    /// ```rust
    /// # use ranch::RangedI128;
    /// assert_eq!(42, RangedI128::<1, 100>::new::<42>().get());
    /// ```
    #[must_use]
    ...
    /// ```rust
    /// # use ranch::RangedI128;
    /// let n = RangedI128::<-128, 127>::new::<0b0101000>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedI128;
    /// let a = RangedI128::<-128, 127>::new::<0b100_0000>();
    /// let b = RangedI128::<-128, 127>::new::<0b100_0011>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedI128;
    /// let a = RangedI128::<1, 100>::new::<50>();
    /// let b = RangedI128::<1, 100>::new::<5>();
    ...
    /// ```rust
    /// # use ranch::RangedI128;
    /// let a = RangedI128::<-100, 100>::new::<50>();
    /// let b = RangedI128::<-100, 100>::new::<5>();
    /// let c = a.saturating_add(b);
    /// let d = RangedI128::<-100, 100>::new::<-75>();
    ///
    ...
    /// let a = RangedI128::<-100, 100>::new::<50>();
    /// let b = RangedI128::<-100, 100>::new::<5>();
    /// let c = RangedI128::<-100, 100>::new::<-75>();
    ///
    ...
    /// let b = RangedI128::<-100, 100>::new::<5>();
    /// let c = RangedI128::<-100, 100>::new::<-75>();
    /// let d = RangedI128::<-100, 100>::new::<2>();
    ///
    ...
    /// let a = RangedI128::<-100, 10>::new::<-50>();
    /// let b = RangedI128::<-10, 100>::new::<50>();
    ///
    /// assert_eq!(
    ///     a.saturating_div(2),
    ///     Quotient::Number(RangedI128::new::<-25>()),
    /// );
    /// assert_eq!(a.saturating_div(0), Quotient::Nan);
    /// assert_eq!(
    ///     a.saturating_div(-1),
    ///     Quotient::Number(RangedI128::new::<10>()),
    /// );
    /// assert_eq!(
    ///     b.saturating_div(-2),
    ///     Quotient::Number(RangedI128::new::<-10>()),
    ...
    /// ```rust
    /// # use ranch::RangedI128;
    /// assert!(!RangedI128::<-100, 100>::new::<10>().is_negative());
    /// assert!(RangedI128::<-100, 100>::new::<-10>().is_negative());
    /// ```
    #[must_use]
    ...
    /// ```rust
    /// # use ranch::RangedI128;
    /// assert!(RangedI128::<-100, 100>::new::<10>().is_positive());
    /// assert!(!RangedI128::<-100, 100>::new::<-10>().is_positive());
    /// ```
    #[must_use]
    ...
    /// ```rust
    /// # use ranch::RangedI128;
    /// let a = RangedI128::<-8, 8>::new::<0>();
    /// let b = RangedI128::<-8, 8>::new::<2>();
    /// let c = RangedI128::<-8, 8>::new::<4>();
    /// let d = RangedI128::<-8, 8>::new::<-1>();
    /// let e = RangedI128::<-8, 8>::new::<-7>();
    /// let f = RangedI128::<-8, 8>::new::<-3>();
    /// let g = RangedI128::<-8, 8>::new::<3>();
    /// let h = RangedI128::<-8, 8>::new::<7>();
    ///
    ...
    /// let output: RangedI128::<0, 6> = a.add_ranged(b);
    ///
    ...
    /// let a = RangedI128::<1, 3>::new::<1>();
    /// let b = RangedI128::<-1, 3>::new::<2>();
    /// let output: RangedI128::<1, 6> = a.add_ranged(b);
    ///
    /// assert_eq!(output.get(), 3);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedI128::<-1, 6> = a.sub_ranged(b);
    ///
    ...
    /// let a = RangedI128::<2, 5>::new::<3>();
    /// let b = RangedI128::<-1, 3>::new::<1>();
    /// let output: RangedI128::<0, 6> = a.sub_ranged(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// # use ranch::RangedI128;
    /// let a = RangedI128::<2, 5>::new::<3>();
    /// let b = RangedI128::<1, 2>::new::<2>();
    /// let output: RangedI128::<1, 2> = a.div_ranged(b).number().unwrap();
    ///
    ...
    /// let output: RangedI128::<0, 2> = a.div_ranged(b).number().unwrap();
    ///
    /// assert_eq!(output.get(), 1);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    >(
        ...
        if rhs.get() == 0 {
            ...
            Quotient::Number(RangedI128::from_unchecked(self.get() / rhs.get()))
        }
    }
    ...
    /// let output: RangedI128::<-1, 27> = a.pow_ranged(b);
    ///
    ...
    /// let a = RangedI128::<1, 3>::new::<2>();
    /// let b = RangedU32::<2, 3>::new::<2>();
    /// let output: RangedI128::<0, 27> = a.pow_ranged(b);
    ///
    /// assert_eq!(output.get(), 4);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    >(
        ...
        RangedI128::from_unchecked(self.get().pow(rhs.get()))
    }
}
...
impl<const MIN: i128, const MAX: i128> error::Clamp for RangedI128<MIN, MAX> {
