...
impl<const MIN: u32, const MAX: u32> RangedU32<MIN, MAX> {
    ...
    /// ```rust
    /// # use ranch::RangedU32;
    /// assert_eq!(42, RangedU32::<1, 100>::new::<42>().get());
    /// ```
    #[must_use]
    ...
    /// ```rust
    /// # use ranch::RangedU32;
    /// let n = RangedU32::<0, 255>::new::<0b0101000>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU32;
    /// let a = RangedU32::<0, 255>::new::<0b100_0000>();
    /// let b = RangedU32::<0, 255>::new::<0b100_0011>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU32;
    /// let a = RangedU32::<1, 100>::new::<50>();
    /// let b = RangedU32::<1, 100>::new::<5>();
    ...
    /// let a = RangedU32::<0, 100>::new::<50>();
    /// let b = RangedU32::<0, 100>::new::<5>();
    /// let c = RangedU32::<0, 100>::new::<75>();
    ///
    ...
    /// let a = RangedU32::<1, 50>::new::<50>();
    /// let b = RangedU32::<1, 50>::new::<1>();
    ///
    /// assert_eq!(
    ///     a.checked_div(2),
    ///     Some(Quotient::Number(RangedU32::new::<25>())),
    /// );
    ...
    /// assert_eq!(
    ///     a.saturating_div(2),
    ///     Quotient::Number(RangedU32::new::<25>()),
    /// );
    /// assert_eq!(a.saturating_div(0), Quotient::Nan);
    /// assert_eq!(
    ///     b.saturating_div(2),
    ///     Quotient::Number(RangedU32::new::<1>()),
    /// );
    /// ```
    #[must_use = "this returns the result of the operation, \
                  without modifying the original"]
    ...
    /// ```rust
    /// # use ranch::{Error, RangedU32};
    /// let a = RangedU32::<0, 33>::new::<0>();
    /// let b = RangedU32::<0, 33>::new::<9>();
    /// let c = RangedU32::<0, 33>::new::<32>();
    /// let d = RangedU32::<0, 33>::new::<33>();
    ///
    ...
    /// ```rust
    /// # use ranch::{Error, RangedU32};
    /// let a = RangedU32::<0, 32>::new::<0>();
    /// let b = RangedU32::<0, 32>::new::<9>();
    /// let c = RangedU32::<0, 32>::new::<32>();
    /// let d = RangedU32::<0, 32>::new::<1>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU32;
    /// let a = RangedU32::<0, 8>::new::<0>();
    /// let b = RangedU32::<0, 8>::new::<2>();
    /// let c = RangedU32::<0, 8>::new::<4>();
    /// let d = RangedU32::<0, 8>::new::<3>();
    /// let e = RangedU32::<0, 8>::new::<7>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU32;
    /// let a = RangedU32::<1, 3>::new::<1>();
    /// let b = RangedU32::<1, 3>::new::<2>();
    /// let output: RangedU32::<2, 6> = a.ranged_add(b);
    ///
    ...
    /// let a = RangedU32::<1, 3>::new::<1>();
    /// let b = RangedU32::<1, 3>::new::<2>();
    /// let output: RangedU32::<1, 6> = a.ranged_add(b);
    ///
    /// assert_eq!(output.get(), 3);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU32::<0, 4> = a.ranged_sub(b);
    ///
    ...
    /// let a = RangedU32::<2, 5>::new::<3>();
    /// let b = RangedU32::<1, 2>::new::<1>();
    /// let output: RangedU32::<0, 3> = a.ranged_sub(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU32::<2, 9> = a.ranged_mul(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    ///
    ...
    /// let a = RangedU32::<1, 3>::new::<1>();
    /// let b = RangedU32::<2, 3>::new::<2>();
    /// let output: RangedU32::<1, 9> = a.ranged_mul(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU32::<1, 2> = a.ranged_div(b);
    ///
    ...
    /// let a = RangedU32::<2, 5>::new::<3>();
    /// let b = RangedU32::<1, 2>::new::<1>();
    /// let output: RangedU32::<0, 2> = a.ranged_div(b);
    ///
    /// assert_eq!(output.get(), 1);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// ```rust
    /// # use ranch::RangedU32;
    /// let a = RangedU32::<1, 3>::new::<2>();
    /// let b = RangedU32::<2, 3>::new::<2>();
    /// let output: RangedU32::<1, 27> = a.ranged_pow(b);
    ///
    ...
    /// let a = RangedU32::<1, 3>::new::<2>();
    /// let b = RangedU32::<2, 3>::new::<2>();
    /// let output: RangedU32::<0, 27> = a.ranged_pow(b);
    ///
    /// assert_eq!(output.get(), 4);
    /// ```
    #[must_use = "this returns the result of the operation, \
