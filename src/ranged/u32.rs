...
impl<const MIN: u32, const MAX: u32> RangedU32<MIN, MAX> {
    ...
    >(
        ...
        RangedU32::from_unchecked(self.get() + rhs.get())
    }
    ...
    >(
        ...
        RangedU32::from_unchecked(self.get().pow(rhs.get()))
    }
}
...
impl<const MIN: u32, const MAX: u32> error::Clamp for RangedU32<MIN, MAX> {
