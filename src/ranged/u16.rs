...
impl<const MIN: u16, const MAX: u16> RangedU16<MIN, MAX> {
    ...
    >(
        ...
        RangedU16::from_unchecked(self.get() + rhs.get())
    }
    ...
    >(
        ...
        if rhs.get() == 0 {
            ...
            Quotient::Number(RangedU16::from_unchecked(self.get() / rhs.get()))
        }
    }
    ...
    >(
        ...
        RangedU16::from_unchecked(self.get().pow(rhs.get()))
    }
}
...
impl<const MIN: u16, const MAX: u16> error::Clamp for RangedU16<MIN, MAX> {
