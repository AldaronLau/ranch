...
impl<const MIN: u64, const MAX: u64> RangedU64<MIN, MAX> {
    ...
    /// let output: RangedU64::<2, 6> = a.add_ranged(b);
    ///
    ...
    /// let a = RangedU64::<1, 3>::new::<1>();
    /// let b = RangedU64::<1, 3>::new::<2>();
    /// let output: RangedU64::<1, 6> = a.add_ranged(b);
    ///
    /// assert_eq!(output.get(), 3);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU64::<0, 4> = a.sub_ranged(b);
    ///
    ...
    /// let a = RangedU64::<2, 5>::new::<3>();
    /// let b = RangedU64::<1, 2>::new::<1>();
    /// let output: RangedU64::<0, 3> = a.sub_ranged(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU64::<2, 9> = a.mul_ranged(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    ///
    ...
    /// let a = RangedU64::<1, 3>::new::<1>();
    /// let b = RangedU64::<2, 3>::new::<2>();
    /// let output: RangedU64::<1, 9> = a.mul_ranged(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
