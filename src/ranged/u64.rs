...
#[repr(transparent)]
pub struct RangedU64<const MIN: u64, const MAX: u64>(pub(crate) u64);
...
impl<const MIN: u64, const MAX: u64> RangedU64<MIN, MAX> {
    ...
    /// RangedU64::<1, 2>::with_u64(1).unwrap();
    /// RangedU64::<1, 2>::with_u64(2).unwrap();
    /// assert_eq!(RangedU64::<1, 2>::with_u64(0).unwrap_err(), Error::NegOverflow);
    /// assert_eq!(RangedU64::<1, 2>::with_u64(3).unwrap_err(), Error::PosOverflow);
    /// ```
    ...
    /// ```rust
    /// # use ranch::RangedU64;
    /// assert_eq!(42, RangedU64::<1, 100>::new::<42>().get());
    /// ```
    #[must_use]
    ...
    /// ```rust
    /// # use ranch::RangedU64;
    /// let n = RangedU64::<0, 255>::new::<0b0101000>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU64;
    /// let a = RangedU64::<0, 255>::new::<0b100_0000>();
    /// let b = RangedU64::<0, 255>::new::<0b100_0011>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU64;
    /// let a = RangedU64::<1, 100>::new::<50>();
    /// let b = RangedU64::<1, 100>::new::<5>();
    ...
    /// let a = RangedU64::<0, 100>::new::<50>();
    /// let b = RangedU64::<0, 100>::new::<5>();
    /// let c = RangedU64::<0, 100>::new::<75>();
    ///
    ...
    ///
    /// ```rust
    /// # use ranch::{Error, RangedU64, Quotient};
    /// let a = RangedU64::<1, 50>::new::<50>();
    /// let b = RangedU64::<1, 50>::new::<1>();
    ///
    /// assert_eq!(
    ///     a.checked_div(2),
    ///     Some(Quotient::Number(RangedU64::new::<25>())),
    /// );
    ...
    /// assert_eq!(
    ///     a.saturating_div(2),
    ///     Quotient::Number(RangedU64::new::<25>()),
    /// );
    /// assert_eq!(a.saturating_div(0), Quotient::Nan);
    /// assert_eq!(
    ///     b.saturating_div(2),
    ///     Quotient::Number(RangedU64::new::<1>()),
    /// );
    /// ```
    #[must_use = "this returns the result of the operation, \
                  without modifying the original"]
    ...
    /// ```rust
    /// # use ranch::{Error, RangedU64};
    /// let a = RangedU64::<0, 32>::new::<0>();
    /// let b = RangedU64::<0, 32>::new::<9>();
    /// let c = RangedU64::<0, 32>::new::<32>();
    /// let d = RangedU64::<0, 32>::new::<1>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU64;
    /// let a = RangedU64::<0, 8>::new::<0>();
    /// let b = RangedU64::<0, 8>::new::<2>();
    /// let c = RangedU64::<0, 8>::new::<4>();
    /// let d = RangedU64::<0, 8>::new::<3>();
    /// let e = RangedU64::<0, 8>::new::<7>();
    ///
    ...
    /// ```rust
    /// # use ranch::RangedU64;
    /// let a = RangedU64::<1, 3>::new::<1>();
    /// let b = RangedU64::<1, 3>::new::<2>();
    /// let output: RangedU64::<2, 6> = a.ranged_add(b);
    ///
    ...
    /// let a = RangedU64::<1, 3>::new::<1>();
    /// let b = RangedU64::<1, 3>::new::<2>();
    /// let output: RangedU64::<1, 6> = a.ranged_add(b);
    ///
    /// assert_eq!(output.get(), 3);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU64::<0, 4> = a.ranged_sub(b);
    ///
    ...
    /// let a = RangedU64::<2, 5>::new::<3>();
    /// let b = RangedU64::<1, 2>::new::<1>();
    /// let output: RangedU64::<0, 3> = a.ranged_sub(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// # use ranch::RangedU64;
    /// let a = RangedU64::<1, 3>::new::<1>();
    /// let b = RangedU64::<2, 3>::new::<2>();
    /// let output: RangedU64::<2, 9> = a.ranged_mul(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    ///
    ...
    /// let a = RangedU64::<1, 3>::new::<1>();
    /// let b = RangedU64::<2, 3>::new::<2>();
    /// let output: RangedU64::<1, 9> = a.ranged_mul(b);
    ///
    /// assert_eq!(output.get(), 2);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU64::<1, 2> = a.ranged_div(b);
    ///
    ...
    /// let a = RangedU64::<2, 5>::new::<3>();
    /// let b = RangedU64::<1, 2>::new::<1>();
    /// let output: RangedU64::<0, 2> = a.ranged_div(b);
    ///
    /// assert_eq!(output.get(), 1);
    /// ```
    #[must_use = "this returns the result of the operation, \
    ...
    /// let output: RangedU64::<1, 27> = a.ranged_pow(b);
    ///
    ...
    /// let a = RangedU64::<1, 3>::new::<2>();
    /// let b = RangedU32::<2, 3>::new::<2>();
    /// let output: RangedU64::<0, 27> = a.ranged_pow(b);
    ///
    /// assert_eq!(output.get(), 4);
    /// ```
    #[must_use = "this returns the result of the operation, \
